...
public class KnrReportCard_BAMS_CoursePattern extends BasicFunctions {
	...
	public void processBAMSPatternPdf(File latestFile, String Regno, String semester, String regulation, Object paper1,
		...
		if (latestFile != null) {
			try (PDDocument document = PDDocument.load(latestFile)) {
				...
				for (int page = 1; page <= totalPages; page++) {
					...
					if ((courseNameRegexPatternMatcher.group().replaceAll("\\s+", "").equalsIgnoreCase("BAMS"))
						...
						try {
							...
							Pattern bamsY1R16SubjectRegexPattern = Pattern
									.compile("^([A-Z &'\\-(),/]+(?:\\s+[A-Z &'\\-(),/]+)*)\\s+" + // Subject name
...
//								subject = fourPatternMatcher.group(1).trim();
									subject = (bamsY1R16SubjectRegexPatternMatcher.group(2) == null)
											? bamsY1R16SubjectRegexPatternMatcher.group(1).replaceAll("\\s+", " ")
													.trim()
											: (bamsY1R16SubjectRegexPatternMatcher.group(1) + " "
													+ bamsY1R16SubjectRegexPatternMatcher.group(2))
													.replaceAll("\\s+", " ").trim();

									String theoryMaxMarks = bamsY1R16SubjectRegexPatternMatcher.group(3)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F); // Take the last part; //
																			// Take the last part

									String theorySecMarks = bamsY1R16SubjectRegexPatternMatcher.group(4)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F); // Take the last part;
									String praticalMaxMarks = bamsY1R16SubjectRegexPatternMatcher.group(5)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F); // Take the last part;
									String praticalSecMarks = bamsY1R16SubjectRegexPatternMatcher.group(6)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F); // Take the last part;

									String vivaMaxMarks = bamsY1R16SubjectRegexPatternMatcher.group(7)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F); // Take the last part;
									String vivaSecMarks = bamsY1R16SubjectRegexPatternMatcher.group(8)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F); // Take the last part;
									String grandTotalMaxMarks = bamsY1R16SubjectRegexPatternMatcher.group(9)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F); // Take the last part;
									String grandTotalSecMarks = bamsY1R16SubjectRegexPatternMatcher.group(10)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F); // Take the last part;
									...
									if ((status.trim().equals("Pass") || status.trim().equals("Fail")
										...
										try {
											...
											PageValidation.validateMarks(Regno, "Paper1 Sec Marks", paper1, paper2,
													...
													subjectToFind, status, grandTotal, theorySecMarks, theoryMaxMarks,
													0.50, testCaseName);

										} catch (Exception e) {
											ExtentTest testCaseScenario1 = testCaseScenario.createNode(
													"Theory Sec. Marks " + subject + " Test case has started running");
										...
										try {
											...
											PageValidation.validateMarks(Regno, "Paper2 Sec Marks", paper1, paper2,
													paper3, paper4, theoryExamTotal, practicalExamTotal, subject,
													subjectToFind, status, grandTotal, vivaSecMarks, vivaMaxMarks, 0.50,
													testCaseName);

										} catch (Exception e) {
											ExtentTest testCaseScenario1 = testCaseScenario.createNode(
													"Viva Sec. Marks " + subject + " Test case has started running");
											testCaseScenario1.log(Status.FAIL,
													"\n Please check The Following Registration number " + Regno
															+ " for the Subject " + subject + " of Viva sec mark is: "
															+ vivaSecMarks,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
										...
										try {
											...
											PageValidation.validateMarks(Regno, "Pratical Total Sec Marks", paper1,
													...
													subject, subjectToFind, status, grandTotal, praticalSecMarks,
											...
											testCaseScenario1.log(Status.FAIL,
													"\n Please check The Following Registration number " + Regno
															...
															+ " of pravtical sec mark is: " + praticalSecMarks,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
										...
										try {
											...
											PageValidation.validateMarks(Regno, "Grand Total Sec Marks", paper1, paper2,
													paper3, paper4, theoryExamTotal, practicalExamTotal, subject,
													subjectToFind, status, grandTotal, grandTotalSecMarks,
											...
											testCaseScenario1.log(Status.FAIL,
													"\n Please check The Following Registration number " + Regno
															+ "Grand Total Sec Marks" + grandTotalSecMarks,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
						...
						try {
							...
							Pattern bamsY3R16SubjectRegexPattern = Pattern
									.compile("^([A-Z &'\\-(),/]+(?:\\s+[A-Z &'\\-(),/]+)*)\\s+" + // Subject name
											"(?:\\(([^)]+)\\))?\\s*" + // Optional (paper name)
											"((?:\\d+\\s*\\(F\\)|\\d+|F|---|NA|NE(?:\\s*\\(AT\\))?|AB))\\s+" + // Mark 1
											"((?:\\d+\\s*\\(F\\)|\\d+|F|---|NA|NE(?:\\s*\\(AT\\))?|AB))\\s+" + // Mark 2
...
//									subject = fourPatternMatcher.group(1).trim();
									subject = (bamsY3R16SubjectRegexPatternMatcher.group(2) == null)
											? bamsY3R16SubjectRegexPatternMatcher.group(1).replaceAll("\\s+", " ")
													.trim()
											: (bamsY3R16SubjectRegexPatternMatcher.group(1) + " "
													+ bamsY3R16SubjectRegexPatternMatcher.group(2))
													.replaceAll("\\s+", " ").trim();

									String theoryMaxMarks = bamsY3R16SubjectRegexPatternMatcher.group(3)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F); // Take the last part

									String theorySecMarks = bamsY3R16SubjectRegexPatternMatcher.group(4)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F);
									String praticalMaxMarks = bamsY3R16SubjectRegexPatternMatcher.group(5)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F);
									String praticalSecMarks = bamsY3R16SubjectRegexPatternMatcher.group(6)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F);

									String vivaMaxMarks = bamsY3R16SubjectRegexPatternMatcher.group(7)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F);
									String vivaSecMarks = bamsY3R16SubjectRegexPatternMatcher.group(8)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F);
									String grandTotalMaxMarks = bamsY3R16SubjectRegexPatternMatcher.group(9)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F);
									String grandTotalSecMarks = bamsY3R16SubjectRegexPatternMatcher.group(10)
											.replaceAll("\\s*\\(F\\)", ""); // Removes (F);
								...
								try {
									testCaseScenario.log(Status.PASS,
											"Subject Pattern validation for the course name "
													+ courseNameRegexPatternMatcher.group() + " of the  following "
													+ Regno + " has matched");
									subject = bamsY4R16SubjectRegexPatternMatcher.group(1).replaceAll("\\s+", " ")
											.trim();

									String theoryTotalMaxMarks = bamsY4R16SubjectRegexPatternMatcher.group(2);
									String theoryTotalSecMarks = bamsY4R16SubjectRegexPatternMatcher.group(3)
									...
									String practicalSecMarks = bamsY4R16SubjectRegexPatternMatcher.group(5)
											.replaceAll("[^0-9]", "").isEmpty()
									...
									String grandTotalSecMarks = bamsY4R16SubjectRegexPatternMatcher.group(7)
											.replaceAll("[^0-9]", "").isEmpty()
									...
									if ((status.trim().equals("Pass") || status.trim().equals("Fail")
										...
										try {
											...
											PageValidation.validateMarks(Regno, "Paper1 Sec Marks", paper1, paper2,
													paper3, paper4, theoryExamTotal, practicalExamTotal, subject,
													subjectToFind, status, grandTotal, theoryTotalSecMarks,
										...
										try {
											if (theoryTotalSecMarks.trim().equals("AB")
													&& !practicalSecMarks.trim().equals("NE (AT)")) {

												ExtentTest testCaseScenario1 = testCaseName.createNode(
														"Theory and Pratical Sec. Marks Validation for the Subject "
																+ subject + " Test case has started running");

												testCaseScenario1.log(Status.FAIL,
														"\n Please check The Following Registration number " + Regno
																+ " for the Subject " + subject
																+ " of theory sec mark is: " + theoryTotalSecMarks
																+ " Pratical Sec is:" + practicalSecMarks,
												...
												System.out.println("\n Please check The Following Registration number "
														...
														+ " Pratical plus viva Sec is :" + practicalSecMarks);
												...
												testCaseScenario1.log(Status.PASS,
														"The Following Registration number " + Regno
																+ " for the Subject " + subject
																+ " of theory  mark is: " + theoryTotalSecMarks
																+ " Pratical Sec mark is : " + practicalSecMarks);
										...
										try {
											...
											PageValidation.validateMarks(Regno, "Pratical Total Sec Marks", paper1,
													paper2, paper3, paper4, theoryExamTotal, practicalExamTotal,
													subject, subjectToFind, status, grandTotal, practicalSecMarks,
													practicalMaxMarks, 0.50, testCaseName);
											...
											testCaseScenario1.log(Status.FAIL,
													"\n Please check The Following Registration number " + Regno
															+ " for the Subject " + subject
															+ " of pravtical sec mark is: " + practicalSecMarks,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
...
//									subject = fourPatternMatcher.group(1).trim();
							...
							&& (semester.trim().equalsIgnoreCase("Year 1")) && (regulation.trim().contains("2021"))) {
						try {
							ExtentTest testCaseScenario = testCaseName.createNode(
									"Pattern validation for the course name " + courseNameRegexPatternMatcher.group()
											+ " of the  following " + Regno + " Test case");
							...
							Pattern bamsY1R21SubjectRegexPattern = Pattern.compile(
									"^(?!Fail|Pass|AP|NE(?:\\s*\\(AT\\))?|AB|Theory|KALOJI NARAYANA RAO UNIVERSITY OF HEALTH SCIENCES|Practical|Secured Marks in Words: |Grand Total|Controller of Examinations|Principal)\\s*"
											+ "([A-Z][A-Za-z &,\\-]+(?:\\s+[A-Za-z &,\\-]+)*?(?:-[1-9])?)\\s+"
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 2:
																											// Theory
																											// Int Max
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 3:
																											// Theory
																											// Int Sec
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 4:
																											// Theory
																											// Univ Max
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 5:
																											// Theory
																											// Univ Sec
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 6:
																											// Prac Int
																											// Max
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 7:
																											// Prac Int
																											// Sec
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 8:
																											// Prac Univ
																											// Max
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 9:
																											// Prac Univ
																											// Sec
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)\\s+" // Group 10: Theory + Prac Max
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 11:
																											// Theory +
																											// Prac Sec
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 12:
																											// Grand Max
											+ "(\\d+|NA|NE(?:\\s*\\(AT\\))?|AB|---)(?:\\s+\\(F\\))?\\s+" // Group 13:
																											// Grand Sec
											+ "(Pass|Fail|AP)",
									Pattern.MULTILINE);
								...
								try {
									...
									if ((status.trim().equals("Pass") || status.trim().equals("Fail")
										...
										try {
											...
											PageValidation.nonValidateMarks(Regno, "Theory paper 1 marks", subject,
													subjectToFind, theoryPaper1, totalTheoryMaxMarks, 0.0,
													testCaseName);
										}

										catch (Exception e) {
											ExtentTest testCaseScenario1 = testCaseScenario
													.createNode("Theory paper 1 marks validation for the subject "
															+ subject + " Test case has started running");

											testCaseScenario1.log(Status.FAIL,
													"The following Register number " + Regno + " for the subject "
															+ subject + " Theory paper 1 marks is: " + theoryPaper1,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
										...
										try {
											...
											PageValidation.nonValidateMarks(Regno, "Theory paper 2 marks", subject,
													subjectToFind, theoryPaper2, totalTheoryMaxMarks, 0.0,
													testCaseName);
										}

										catch (Exception e) {
											ExtentTest testCaseScenario1 = testCaseScenario
													.createNode("Theory paper 2 marks validation for the subject "
															+ subject + " Test case has started running");

											testCaseScenario1.log(Status.FAIL,
													"The following Register number " + Regno + " for the subject "
															+ subject + " Theory paper 2 marks is: " + theoryPaper2,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
										...
										try {
											PageValidation.validateMarks(Regno, "Paper1 Sec Marks", paper1, paper2,
													paper3, paper4, theoryExamTotal, practicalExamTotal, subject,
													subjectToFind, status, grandTotal, totalTheorySecMarks,
													totalTheoryMaxMarks, 0.50, testCaseName);
										...
										try {
											...
											PageValidation.nonValidateMarks(Regno, "Internal Assessment Sec. Marks",
													subject, subjectToFind, internalAssessmentSecMark,
													totalPracticalMaxMarks, 0.0, testCaseName);
										}
											...
											testCaseScenario1.log(Status.FAIL,
													"The following Register number " + Regno + " for the subject "
															+ subject + "Internal Assessment Sec. Marks is: "
															+ theoryPaper2,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
											...
											System.out.println("The following Register number " + Regno
													+ " for the subject " + subject
													+ " Internal Assessment Sec. Marks is: " + theoryPaper2);

										}
										try {

											PageValidation.nonValidateMarks(Regno, "Elective Sec. Marks", subject,
													subjectToFind, electiveSecMark, totalPracticalMaxMarks, 0.0,
													testCaseName);
										}
											...
											testCaseScenario1.log(Status.FAIL,
													"The following Register number " + Regno + " for the subject "
															+ subject + "Elective Sec. Marks is: " + electiveSecMark,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
										...
										try {
											...
											PageValidation.nonValidateMarks(Regno, "Practical Sec Mark", subject,
													subjectToFind, practicalSecMark, totalPracticalMaxMarks, 0.0,
													testCaseName);
										}
											...
											testCaseScenario1.log(Status.FAIL,
													"The following Register number " + Regno + " for the subject "
															+ subject + "Practical Sec. Marks is: " + practicalSecMark,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());

											System.out.println("The following Register number " + Regno
													+ " for the subject " + subject + " Practical Sec. Marks is: "
													+ practicalSecMark);

										}
										try {

											PageValidation.nonValidateMarks(Regno, "Viva Sec Mark", subject,
													subjectToFind, vivaSecMark, totalPracticalMaxMarks, 0.0,
													testCaseName);
										}

										catch (Exception e) {
											ExtentTest testCaseScenario1 = testCaseName
													.createNode("Viva Sec Mark Validation for the Subject " + subject
															+ " Test case has started running");
											testCaseScenario1.log(Status.FAIL,
													"The following Register number " + Regno + " for the subject "
															+ subject + "Viva Sec. Marks is: " + vivaSecMark,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
										...
										try {
											...
											PageValidation.validateMarks(Regno, "Theory Total Sec Marks", paper1,
													paper2, paper3, paper4, theoryExamTotal, practicalExamTotal,
													subject, subjectToFind, status, grandTotal, totalTheorySecMarks,
													totalTheoryMaxMarks, 0.50, testCaseName);
										}
											...
											testCaseScenario1.log(Status.FAIL,
													"\n Please check The Following Registration number " + Regno
															+ "Theory Total Sec Marks" + totalTheorySecMarks,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
										...
										try {
											...
											PageValidation.validateMarks(Regno, "Pratical Total Sec Marks", paper1,
													paper2, paper3, paper4, theoryExamTotal, practicalExamTotal,
													subject, subjectToFind, status, grandTotal, totalPracticalSecMarks,
													totalPracticalMaxMarks, 0.50, testCaseName);
											...
											testCaseScenario1.log(Status.FAIL,
													"\n Please check The Following Registration number " + Regno
															+ " for the Subject " + subject
															+ " of pravtical sec mark is: " + totalPracticalSecMarks,
													MediaEntityBuilder
															.createScreenCaptureFromPath(BasicFunctions.capture(driver))
															.build());
							...
							&& (semester.trim().equalsIgnoreCase("Year 2")) && (regulation.trim().contains("2021"))) {
						try {
							ExtentTest testCaseScenario = testCaseName.createNode(
									"Pattern validation for the course name " + courseNameRegexPatternMatcher.group()
											+ " of the  following " + Regno + " Test case");
